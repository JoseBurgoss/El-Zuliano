    ...
    <>
        <div className='book-container section-container'>
            ...
            <div className='book-input-container'>
                <div className='flex-column'>
                    ...
                    <div className='searchbar-container'>
                        ...
                        onClick={handleButtonClick}>Ir</button>
                    </div>
                </div>
            </div>
            ...
            <div style={{margin: '2rem 0'}}>
                ...
                {(noResultsFound && <h3>No se encontraron resultados</h3>)}
                    ...
                    <div className='book-review-container'>
                        {bookReviews.map((review, index) => (
                            <div key={index}>
                                <p>{review.summary}</p>
                                {review.byline && (
                                    <span>Por {review.byline}</span>
                                )}
                                <Link to={review.url} className='review-link'>
                                    <p>Lee la Reseña Completa</p>
                                </Link>
                            </div>
                        ))}
                    </div>
